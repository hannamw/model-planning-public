...
LAST_ONLY = True
PATH_LENGTH_RESULTS_DIR = Path('results/directness_diff_last') if LAST_ONLY else Path('results/directness_difff')  # Directory for path length results
...
for model in models:
    ...
    graph_dir = Path('attribution_graphs_diff') / logit_lens_model_name
