...
for model in models:
    ...
    for idx, row in tqdm(metadata.iterrows()):
        ...
        if a_an_feature_indices:
            ...
            logits_zeros, _ = replacement_model.feature_intervention(s, interventions=zero_interventions, return_activations=False)
            logits_multiply, _ = replacement_model.feature_intervention(s, interventions=multiply_interventions, return_activations=False)
