...
def evaluate_model(model_name: str, dataset_path: str, prompt_template: str, batch_size: int = 8, 
    ...
    dataset = MultihopDataset(df, tokenizer, prompt_template)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default='results/behavioral-continuation', help="Output directory for results CSV")
