...
models = [f'Qwen3-{size}B' for size in [0.6, 1.7, 4, 8, 14]][:3]
dfs = {model: pd.read_csv(f'interventions_random_last/{model}.csv') for model in models}
...
plt.tight_layout()
plt.savefig('interventions_random_last/intervention_effects.pdf', bbox_inches='tight')
plt.show()
#%%
