...
def main():
    """Main function to analyze intervention results."""
    results_dir = Path("results/tinystories_interventions")
    output_dir = Path("results/tinystories_interventions/plots")
