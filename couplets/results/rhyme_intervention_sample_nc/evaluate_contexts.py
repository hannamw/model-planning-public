...
plt.errorbar(x_positions, metrics_df['temp_03_tokens_same'], 
             yerr=metrics_df['temp_03_tokens_same_se'],
             marker='s', linewidth=2, markersize=8, capsize=5,
             label='Temperature 0.3', color='green')

plt.errorbar(x_positions, metrics_df['temp_07_tokens_same'], 
             yerr=metrics_df['temp_07_tokens_same_se'],
...
plt.errorbar(x_positions, metrics_df['intervention_temp_10_tokens_same'], 
             ...
             label='Intervention Temp 1.0', color='orange')
...
plt.errorbar(x_positions, metrics_df['temp_03_pct_orig'], 
             yerr=metrics_df['temp_03_pct_orig_se'],
             marker='s', linewidth=2, markersize=8, capsize=5,
             label='Temperature 0.3', color='green')

plt.errorbar(x_positions, metrics_df['temp_07_pct_orig'], 
             yerr=metrics_df['temp_07_pct_orig_se'],
             marker='^', linewidth=2, markersize=8, capsize=5,
             label='Temperature 0.7', color='red')
...
plt.errorbar(x_positions, metrics_df['temp_03_vowel_correct'], 
             yerr=metrics_df['temp_03_vowel_correct_se'],
             marker='s', linewidth=2, markersize=8, capsize=5,
             label='Temperature 0.3', color='green')

plt.errorbar(x_positions, metrics_df['temp_07_vowel_correct'], 
             yerr=metrics_df['temp_07_vowel_correct_se'],
             marker='^', linewidth=2, markersize=8, capsize=5,
             label='Temperature 0.7', color='red')
...
plt.errorbar(x_positions, metrics_df['temp_03_consonant_correct'], 
             yerr=metrics_df['temp_03_consonant_correct_se'],
             marker='s', linewidth=2, markersize=8, capsize=5,
             label='Temperature 0.3', color='green')

plt.errorbar(x_positions, metrics_df['temp_07_consonant_correct'], 
             yerr=metrics_df['temp_07_consonant_correct_se'],
             marker='^', linewidth=2, markersize=8, capsize=5,
             label='Temperature 0.7', color='red')
...
temp_03_vowel_consonant_correct = []
temp_03_vowel_consonant_correct_se = []
temp_07_vowel_consonant_correct = []
temp_07_vowel_consonant_correct_se = []
...
for model in models:
    ...
    # Temperature 0.3
    temp_03_combined = (model_data['temp_0.3_vowel_correct'] * model_data['temp_0.3_consonant_correct'])
    temp_03_vowel_consonant_correct.append(temp_03_combined.mean())
    temp_03_vowel_consonant_correct_se.append(temp_03_combined.sem())
    
    # Temperature 0.7
    temp_07_combined = (model_data['temp_0.7_vowel_correct'] * model_data['temp_0.7_consonant_correct'])
    temp_07_vowel_consonant_correct.append(temp_07_combined.mean())
    temp_07_vowel_consonant_correct_se.append(temp_07_combined.sem())
...
plt.errorbar(x_positions, temp_03_vowel_consonant_correct, 
             yerr=temp_03_vowel_consonant_correct_se,
             marker='s', linewidth=2, markersize=8, capsize=5,
             label='Temperature 0.3', color='green')

plt.errorbar(x_positions, temp_07_vowel_consonant_correct, 
             yerr=temp_07_vowel_consonant_correct_se,
             marker='^', linewidth=2, markersize=8, capsize=5,
             label='Temperature 0.7', color='red')
