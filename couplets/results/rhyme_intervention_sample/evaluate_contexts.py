...
for model in models:
    ...
    for idx, row in df.iterrows():
        ...
        print("Temp 0.3 tokens same:", df.loc[idx, 'temp_0.3_tokens_same'])
        print("Temp 0.7 tokens same:", df.loc[idx, 'temp_0.7_tokens_same'])
        print("Temp 1.0 tokens same:", df.loc[idx, 'temp_1.0_tokens_same'])
        print("Temp 0.3 vowel correct:", df.loc[idx, 'temp_0.3_vowel_correct'])
        print("Temp 0.7 vowel correct:", df.loc[idx, 'temp_0.7_vowel_correct'])
...
for model in models:
    ...
    temp_03_tokens_same = model_data['temp_0.3_tokens_same'].mean()
    temp_07_tokens_same = model_data['temp_0.7_tokens_same'].mean()
    temp_10_tokens_same = model_data['temp_1.0_tokens_same'].mean()
    temp_03_pct_orig = (model_data['temp_0.3_tokens_same'] / model_data['orig_len']).mean()
    temp_07_pct_orig = (model_data['temp_0.7_tokens_same'] / model_data['orig_len']).mean()
    temp_10_pct_orig = (model_data['temp_1.0_tokens_same'] / model_data['orig_len']).mean()
    
    # Calculate temperature sampling phonetic metrics
    temp_03_vowel_correct = model_data['temp_0.3_vowel_correct'].mean()
    temp_07_vowel_correct = model_data['temp_0.7_vowel_correct'].mean()
    temp_10_vowel_correct = model_data['temp_1.0_vowel_correct'].mean()
    temp_03_consonant_correct = model_data['temp_0.3_consonant_correct'].mean()
    temp_07_consonant_correct = model_data['temp_0.7_consonant_correct'].mean()
    temp_10_consonant_correct = model_data['temp_1.0_consonant_correct'].mean()
    temp_03_singular_consonant_correct = model_data['temp_0.3_singular_consonant_correct'].mean()
    temp_07_singular_consonant_correct = model_data['temp_0.7_singular_consonant_correct'].mean()
    temp_10_singular_consonant_correct = model_data['temp_1.0_singular_consonant_correct'].mean()
...
plt.plot(x_positions, metrics_df['mean_tokens_same'], 
         marker='o', linewidth=2, markersize=8, 
         label='Intervention', color='blue')

plt.plot(x_positions, metrics_df['temp_03_tokens_same'], 
         marker='s', linewidth=2, markersize=8, 
         label='Temperature 0.3', color='green')

plt.plot(x_positions, metrics_df['temp_07_tokens_same'], 
         marker='^', linewidth=2, markersize=8, 
         label='Temperature 0.7', color='red')

plt.plot(x_positions, metrics_df['temp_10_tokens_same'], 
         marker='d', linewidth=2, markersize=8, 
         label='Temperature 1.0', color='purple')

plt.xlabel('Model')
plt.ylabel('Mean Tokens Same')
plt.title('Mean Tokens Same by Model: Intervention vs Temperature Sampling')
plt.xticks(x_positions, models, rotation=45)
plt.legend()
plt.grid(True, alpha=0.3)
plt.tight_layout()
...
plt.plot(x_positions, metrics_df['tokens_same_pct_orig'], 
         marker='o', linewidth=2, markersize=8, 
         label='Intervention', color='blue')

plt.plot(x_positions, metrics_df['temp_03_pct_orig'], 
         marker='s', linewidth=2, markersize=8, 
         label='Temperature 0.3', color='green')

plt.plot(x_positions, metrics_df['temp_07_pct_orig'], 
         marker='^', linewidth=2, markersize=8, 
         label='Temperature 0.7', color='red')

plt.plot(x_positions, metrics_df['temp_10_pct_orig'], 
         marker='d', linewidth=2, markersize=8, 
         label='Temperature 1.0', color='purple')

plt.xlabel('Model')
plt.ylabel('Tokens Same / Original Length')
plt.title('Tokens Same as % of Original Length: Intervention vs Temperature Sampling')
plt.xticks(x_positions, models, rotation=45)
plt.legend()
plt.grid(True, alpha=0.3)
plt.tight_layout()
...
plt.plot(x_positions, metrics_df['temp_03_vowel_correct'], 
         marker='s', linewidth=2, markersize=8, 
         label='Temperature 0.3', color='green')

plt.plot(x_positions, metrics_df['temp_07_vowel_correct'], 
         marker='^', linewidth=2, markersize=8, 
         label='Temperature 0.7', color='red')

plt.plot(x_positions, metrics_df['temp_10_vowel_correct'], 
         marker='d', linewidth=2, markersize=8, 
         label='Temperature 1.0', color='purple')

plt.xlabel('Model')
plt.ylabel('Vowel Correctness Rate')
plt.title('Vowel Correctness by Model: Intervention vs Temperature Sampling')
plt.xticks(x_positions, models, rotation=45)
plt.legend()
plt.grid(True, alpha=0.3)
plt.tight_layout()
...
plt.plot(x_positions, metrics_df['temp_03_consonant_correct'], 
         marker='s', linewidth=2, markersize=8, 
         label='Temperature 0.3', color='green')

plt.plot(x_positions, metrics_df['temp_07_consonant_correct'], 
         marker='^', linewidth=2, markersize=8, 
         label='Temperature 0.7', color='red')

plt.plot(x_positions, metrics_df['temp_10_consonant_correct'], 
         marker='d', linewidth=2, markersize=8, 
         label='Temperature 1.0', color='purple')

plt.xlabel('Model')
plt.ylabel('Consonant Correctness Rate')
plt.title('Consonant Correctness by Model: Intervention vs Temperature Sampling')
plt.xticks(x_positions, models, rotation=45)
plt.legend()
plt.grid(True, alpha=0.3)
plt.tight_layout()
...
temp_03_vowel_consonant_correct = metrics_df['temp_03_vowel_correct'] * metrics_df['temp_03_consonant_correct']
temp_07_vowel_consonant_correct = metrics_df['temp_07_vowel_correct'] * metrics_df['temp_07_consonant_correct']
temp_10_vowel_consonant_correct = metrics_df['temp_10_vowel_correct'] * metrics_df['temp_10_consonant_correct']

plt.plot(x_positions, metrics_df['vowel_consonant_correct'], 
         marker='o', linewidth=2, markersize=8, 
         label='Intervention', color='blue')

plt.plot(x_positions, temp_03_vowel_consonant_correct, 
         marker='s', linewidth=2, markersize=8, 
         label='Temperature 0.3', color='green')

plt.plot(x_positions, temp_07_vowel_consonant_correct, 
         marker='^', linewidth=2, markersize=8, 
         label='Temperature 0.7', color='red')

plt.plot(x_positions, temp_10_vowel_consonant_correct, 
         marker='d', linewidth=2, markersize=8, 
         label='Temperature 1.0', color='purple')

plt.xlabel('Model')
plt.ylabel('Rhyme Correctness Rate (Vowel & Consonant)')
plt.title('Rhyme Correctness by Model: Intervention vs Temperature Sampling')
plt.xticks(x_positions, models, rotation=45)
plt.legend()
plt.grid(True, alpha=0.3)
plt.tight_layout()
...
for _, row in metrics_df.iterrows():
    ...
    print(f"  Temperature 0.3 Tokens Same: {row['temp_03_tokens_same']:.3f}")
    print(f"  Temperature 0.7 Tokens Same: {row['temp_07_tokens_same']:.3f}")
    print(f"  Temperature 1.0 Tokens Same: {row['temp_10_tokens_same']:.3f}")
    print(f"  Temperature 0.3 % of Original: {row['temp_03_pct_orig']:.3f}")
    print(f"  Temperature 0.7 % of Original: {row['temp_07_pct_orig']:.3f}")
    print(f"  Temperature 1.0 % of Original: {row['temp_10_pct_orig']:.3f}")
    print(f"  Temperature 0.3 Vowel Correct: {row['temp_03_vowel_correct']:.3f}")
    print(f"  Temperature 0.7 Vowel Correct: {row['temp_07_vowel_correct']:.3f}")
    print(f"  Temperature 1.0 Vowel Correct: {row['temp_10_vowel_correct']:.3f}")
    print(f"  Temperature 0.3 Consonant Correct: {row['temp_03_consonant_correct']:.3f}")
    print(f"  Temperature 0.7 Consonant Correct: {row['temp_07_consonant_correct']:.3f}")
    print(f"  Temperature 1.0 Consonant Correct: {row['temp_10_consonant_correct']:.3f}")
    print(f"  Temperature 0.3 Singular Consonant Correct: {row['temp_03_singular_consonant_correct']:.3f}")
    print(f"  Temperature 0.7 Singular Consonant Correct: {row['temp_07_singular_consonant_correct']:.3f}")
