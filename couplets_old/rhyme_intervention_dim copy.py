...
for idx, row in metadata.iterrows():
    ...
    print(input_tokens[im_end_idx - 2])
...
#%%
results_metadata = metadata.head(100).copy()
# Initialize columns for intervention results
results_metadata['found_valid_row'] = False
results_metadata['chosen_id'] = ''
results_metadata['chosen_index'] = 0
results_metadata['chosen_rhyme_group'] = ''
results_metadata['chosen_feature_count'] = 0
results_metadata['original_generation'] = ''
results_metadata['intervention_generation'] = ''
for idx, row in results_metadata.iterrows():
    second_last_word = row['second_last_word']
    rhyme_group = row['rhyme_group']
    ...
    results_metadata.at[idx, 'original_generation'] = original_generation
    ...
    results_metadata.at[idx, 'found_valid_row'] = True
    results_metadata.at[idx, 'chosen_id'] = chosen_id
    results_metadata.at[idx, 'chosen_index'] = chosen_index
    results_metadata.at[idx, 'chosen_rhyme_group'] = chosen_rhyme_group
    ...
    with model.hooks(fwd_hooks=steering_interventions):
    ...
    results_metadata.at[idx, 'intervention_generation'] = new_generation

    
# Ensure output directory exists
Path('results/rhyme_intervention_dim').mkdir(parents=True, exist_ok=True)
results_metadata.to_csv(f'results/rhyme_intervention_dim/{model_name}.csv')
#%%