...
for model_name in models:
    ...
    for idx, row in metadata.iterrows():
        ...
        original_generation_stripped = original_generation[len(input_text):].strip()
        ...
        for temp in temperatures:
            for i in range(5):
                ...
                # Strip input text, keeping only newly generated content
                temp_generation_stripped = temp_generation[len(input_text):].strip()
        ...
        if not valid_rows.empty:
            ...
            new_generation_stripped = new_generation[len(input_text):].strip()
            ...
            for i in range(5):
                ...
                # Strip input text, keeping only newly generated content
                intervention_temp_generation_stripped = intervention_temp_generation[len(input_text):].strip()
