...
#%%
prompt = 'A silent tear on truth\'s tightrope spin,'
raw_completion = 'And silence speaks where'
last_word = 'words'
slug = 'Qwen3-14B-speaks-where'
example = Example(chattify([f'/no_think Write only the next line of this rhyming couplet: {prompt}', 
                    f'{raw_completion}'], model.tokenizer), 
                    f' {last_word}', 
                    slug
                 ) 
